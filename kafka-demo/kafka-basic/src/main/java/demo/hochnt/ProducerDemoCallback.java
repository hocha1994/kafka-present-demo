...
public class ProducerDemoCallback {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            ProducerRecord<String, String> record = new ProducerRecord<>("demo_java", "hello kafka " + i);
            ...
            producer.send(record, new Callback() {// send async
                ...
                public void onCompletion(RecordMetadata metadata, Exception ex) {
                    ...
                    log.info("===========END SHOW METADATA=========\n");
                }
            });

            //TODO: uncomemnt to avoid batching with DefaultPartitioner;
            try {
