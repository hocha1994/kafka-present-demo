...
public class ConsumerDemoCooperative {
    ...
    public static void main(String[] args) {
        ...
        properties.setProperty(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootStrapServers); // or "127.0.0.1:9092
        ...
        // config rebalanced mode
        properties.setProperty(ConsumerConfig.PARTITION_ASSIGNMENT_STRATEGY_CONFIG, CooperativeStickyAssignor.class.getName());
        // set up consumer group id for static assignment
        // properties.setProperty(ConsumerConfig.GROUP_INSTANCE_ID_CONFIG, "");
        // => different value for all consumer
